...
public class Solution {
	...
	static class Bio implements Comparable<Bio>{
		...
		public String toString() {
			return "Bio [x=" + x + ", y=" + y + ", num=" + num + ", dir=" + dir + "] \n";
		}
...
//			System.out.println("before move " + copyBio);
			
			// 이동
			move(copyBio);
			
			Collections.sort(copyBio);
//			System.out.println("after move " + copyBio);
...
//			System.out.println("after add " + copyBio);
...
//			System.out.println("after " +cur.x + " " + cur.y + " " + cur.num + " " + cur.dir);
		}
	}
